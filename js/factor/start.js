...
import { prFact, parseNumber, formatFactors } from './factor.js';
...
export async function start() {
    Console.clearScreen();
    ConsoleLine.displayText('Factor - Factorize numbers into primes');
    ConsoleLine.displayText('========================================');
    ConsoleLine.displayText('');
    ConsoleLine.displayText('Enter numbers to factor (one per line).');
    ...
    while (true) {
        ...
        try {
            const num = parseNumber(input.trim());
            const factors = prFact(num);
            ...
            const result = formatFactors(num, factors);
    ...
    ConsoleLine.displayText('');
    ConsoleLine.displayText('Thanks for using Factor!');
}
