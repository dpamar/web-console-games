/**
 * Pig Latin - Interactive version for web console
 */
...
import { convertText } from './pig.js';
...
export async function start() {
    Console.clearScreen();
    ConsoleLine.displayText('Pig Latin Converter');
    ConsoleLine.displayText('='.repeat(40));
    ConsoleLine.displayText('');
    ConsoleLine.displayText('Enter text to convert to Pig Latin.');
    ...
    ConsoleLine.displayText('');
    ConsoleLine.displayText('Anksthay orfay usingway igpay!');
}
